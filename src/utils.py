...
def get_optim(params, model, filter_bias_and_bn=False, skip_list=(), skip_gain=False):
    ...
    if params['optimizer'] == 'sgd':
        ...
        optimizer = optim.Adam(target, params['lr'], weight_decay=weight_decay)
    elif params['optimizer'] == 'amsgrad':
        optimizer = optim.Adam(target, params['lr'], weight_decay=weight_decay, amsgrad=True)
    elif params['optimizer'] == 'rmsprop':
        optimizer = optim.RMSprop(target, params['lr'], weight_decay=weight_decay)
    elif params['optimizer'] == 'adamw':
        optimizer = optim.AdamW(target, params['lr'], weight_decay=weight_decay)
