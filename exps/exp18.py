...
train_df = pd.read_csv('../input/pet-data/df1_train_test_v5.csv')
train_df = train_df.dropna(subset=['AdoptionSpeed'])
train_df.head()
...
train_df['norm_score'] = (train_df['AdoptionSpeed'] / 4).clip(0, 1)
train_df['norm_score']
