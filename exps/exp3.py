...
import timm
img_size = timm.models.efficientnet.default_cfgs[model_path]['input_size'][-1]
...
def get_learner(fold_num):
    ...
    learn = Learner(data, model, model_dir=model_dir, loss_func=BCEWithLogitsLossFlat(), metrics=petfinder_rmse).to_fp16()
...
for i in range(N_FOLDS):
    ...
    learn.fit_one_cycle(20, 2e-5, 
                            cbs=[SaveModelCallback(fname=f'{model_path}_{i}', 
